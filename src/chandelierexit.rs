//! extern "C" wrapper for `chandelierexit`, mirroring the core `tulip_rs` crate's
//! `ChandelierExit::indicator` / `IndicatorState::batch_indicator` interface with a
...
//! order as `tulip_rs::indicators::chandelierexit::ChandelierExit::INFO.inputs`),
//! `options` is a flat array of `OPTIONS` values -- exactly like
//! `ti_chandelierexit`'s `double const *const *inputs, double const *options`.
//! Output allocation stays inside the indicator function (never caller-supplied).
//!
...
//!
//! SIMD entry points:
//! - `chandelierexit_simd_by_assets`: compute Chandelier Exit for N assets simultaneously,
//!   sharing a single options array. N must be 2, 4, 8, or 16.
//! - `chandelierexit_simd_by_options`: compute Chandelier Exit for one asset with N different
...
use tulip_rs::indicators::chandelierexit::{
    ChandelierExit, IndicatorState as ChandelierExitState, INPUTS, OPTIONS,
};
...
/// `chandelierexit_batch()` / `chandelierexit_state_free()`.
pub type ChandelierExitStateHandle = ChandelierExitState;
...
#[no_mangle]
pub unsafe extern "C" fn chandelierexit_indicator(
...
///   `bool`s.
#[no_mangle]
pub unsafe extern "C" fn chandelierexit_batch(
    state: *mut c_void,
    inputs: *const *const f64,
    data_len: usize,
    optional_outputs: *const bool,
    ...
    let state = &mut *(state as *mut ChandelierExitStateHandle);
...
/// after this call.
#[no_mangle]
pub unsafe extern "C" fn chandelierexit_state_free(state: *mut c_void) {
    if !state.is_null() {
...
///   `bool`s.
#[no_mangle]
pub unsafe extern "C" fn chandelierexit_simd_by_assets(
    ...
    match num_assets {
        2 => chandelierexit_simd_by_assets_n::<2>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        4 => chandelierexit_simd_by_assets_n::<4>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        8 => chandelierexit_simd_by_assets_n::<8>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        16 => chandelierexit_simd_by_assets_n::<16>(
            inputs,
            data_len,
            options,
            optional_outputs,
...
unsafe fn chandelierexit_simd_by_assets_n<const N: usize>(
    inputs: *const *const *const f64,
    data_len: usize,
    options: *const f64,
    optional_outputs: *const bool,
...
///   `bool`s.
#[no_mangle]
pub unsafe extern "C" fn chandelierexit_simd_by_options(
    inputs: *const *const f64,
    data_len: usize,
    ...
    match num_option_sets {
        2 => chandelierexit_simd_by_options_n::<2>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        4 => chandelierexit_simd_by_options_n::<4>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        8 => chandelierexit_simd_by_options_n::<8>(
            inputs,
            data_len,
            options,
            optional_outputs,
        ...
        16 => chandelierexit_simd_by_options_n::<16>(
            inputs,
            data_len,
            options,
            optional_outputs,
...
unsafe fn chandelierexit_simd_by_options_n<const N: usize>(
    inputs: *const *const f64,
    data_len: usize,
    options: *const *const f64,
    optional_outputs: *const bool,
...
mod tests {
    ...
    fn test_chandelierexit_indicator() {
        ...
        unsafe {
            let result = chandelierexit_indicator(
                inputs.as_ptr(),
                data_len,
                options.as_ptr(),
                std::ptr::null(),
    ...
    fn test_chandelierexit_simd_by_assets() {
        ...
        unsafe {
            let result = chandelierexit_simd_by_assets(
                inputs.as_ptr(),
                2,
                data_len,
                options.as_ptr(),
    ...
    fn test_chandelierexit_simd_by_options() {
        ...
        let options1 = [10.0, 2.0];
        let options2 = [20.0, 3.0];
        let options_array = [options1.as_ptr(), options2.as_ptr()];

        unsafe {
            let result = chandelierexit_simd_by_options(
                inputs.as_ptr(),
                data_len,
