...
pub unsafe extern "C" fn cci_simd_by_assets(
    ...
    match num_assets {
        2 => cci_simd_by_assets_n::<2>(inputs, data_len, options, optional_outputs, num_optional),
        4 => cci_simd_by_assets_n::<4>(inputs, data_len, options, optional_outputs, num_optional),
        8 => cci_simd_by_assets_n::<8>(inputs, data_len, options, optional_outputs, num_optional),
        16 => cci_simd_by_assets_n::<16>(inputs, data_len, options, optional_outputs, num_optional),
...
pub unsafe extern "C" fn cci_simd_by_options(
    ...
    match num_option_sets {
        2 => cci_simd_by_options_n::<2>(inputs, data_len, options, optional_outputs, num_optional),
        4 => cci_simd_by_options_n::<4>(inputs, data_len, options, optional_outputs, num_optional),
        8 => cci_simd_by_options_n::<8>(inputs, data_len, options, optional_outputs, num_optional),
        16 => {
            cci_simd_by_options_n::<16>(inputs, data_len, options, optional_outputs, num_optional)
        }
        _ => CSimdResult::err(IndicatorError::InvalidInputs),
    }
}
...
mod tests {
    ...
    fn test_cci_indicator() {
        unsafe {
            ...
            assert_eq!(lens[1], 0); // sma (optional, not requested)
            assert_eq!(lens[2], 0); // md (optional, not requested)
            assert_eq!(lens[3], 0); // typprice (optional, not requested)
