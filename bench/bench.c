...
// Stock data (Stock typedef, DATA_LIMIT) and timing helpers are in bench_common.h.
// load_from_db remains here as it requires libpq declarations.
...
// Timing helpers are now in bench_common.h

// Result collection and reporting are now in bench_common.h
