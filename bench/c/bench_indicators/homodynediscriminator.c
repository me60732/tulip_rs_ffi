...
static void bench_homodynediscriminator(void *ctx_) {
    ...
    double opts[0] = {};
    struct CIndicatorResult r = homodynediscriminator_indicator(inputs, ctx->stock->len, opts, NULL, 0);
...
static void run_homodynediscriminator(const Stock *stocks, int num_stocks, int number, int repeat, int warmup) {
    static const double option_sets[][0] = {{}};  // No options for this indicator
