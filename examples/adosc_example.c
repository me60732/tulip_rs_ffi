...
int main(void) {
    ...
    printf("\n=== ADOSC: SIMD by assets (N=4) ===\n");
    {
        ...
        const double *const asset1[4] = {high, low, close, volume};
        ...
        const double *const asset2[4] = {high_2, low_2, close_2, volume_2};
        ...
        const double *const asset3[4] = {high_3, low_3, close_3, volume_3};
        ...
        const double *const asset4[4] = {high_4, low_4, close_4, volume_4};
    ...
    printf("\n=== ADOSC: SIMD by options (N=4) ===\n");
    {
        ...
        const double *expanded_inputs[4] = {
            high_expanded, low_expanded, close_expanded, volume_expanded};

        static const double options_1[2] = {3.0, 10.0};
        static const double options_2[2] = {4.0, 12.0};
        static const double options_3[2] = {5.0, 15.0};
        static const double options_4[2] = {6.0, 20.0};
